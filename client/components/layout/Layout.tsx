      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:py-4">
        <Link to="/" className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-yellow-300/90 md:text-xs">
              Sikkim Tourism
            </p>
          </div>
        </Link>
        ...
        <div className="hidden items-center gap-1 md:flex">
          ...
          <form
            onSubmit={onSearch}
            className="ml-3 hidden items-center gap-2 md:flex"
          >
            <input
              value={query}
            ...
            <button
              type="submit"
              aria-label="Search"
              className="grid h-10 w-10 place-items-center rounded-md bg-yellow-400/90 text-black shadow hover:bg-yellow-400"
            >
              <svg
                className="h-4 w-4"
                viewBox="0 0 24 24"
          ...
          <div className="overflow-hidden rounded-xl bg-black/85 shadow-xl ring-1 ring-red-500/20">
            <form onSubmit={onSearch} className="flex gap-2 px-4 py-3">
              ...
              <button
                type="submit"
                aria-label="Search"
                className="grid h-10 w-10 place-items-center rounded-md bg-yellow-400/90 text-black"
              >
                <svg
                  className="h-4 w-4"
                  viewBox="0 0 24 24"
  ...
  return (
    <footer className="mt-16 border-t border-border bg-muted/30">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 md:grid-cols-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            A Digital Heritage Platform preserving and showcasing Sikkim’s
            monasteries through immersive 360° experiences, archives, and
            cultural insights.
          </p>
        </div>
        <div>
          ...
          <ul className="grid gap-2 text-sm">
            <li>
              <Link className="hover:text-primary" to="/archives">
                Digital Archives
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className="hover:text-primary" to="/calendar">
                Cultural Calendar
              </Link>
            </li>
            <li>
              <Link className="hover:text-primary" to="/transport">
                Transport & Tourism
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="mt-3 flex gap-3">
            <a
              href="#"
              aria-label="Facebook"
              className="h-9 w-9 rounded-full bg-black/90 text-white grid place-items-center hover:brightness-110"
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M22 12a10 10 0 10-11.5 9.9v-7H7.9V12h2.6V9.8c0-2.6 1.6-4 3.9-4 1.1 0 2.2.2 2.2.2v2.4h-1.2c-1.2 0-1.6.7-1.6 1.5V12h2.7l-.4 2.9h-2.3v7A10 10 0 0022 12" />
              </svg>
            </a>
            <a
              href="#"
            ...
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M21.8 8.5a3 3 0 00-2.1-2.1C18 6 12 6 12 6s-6 0-7.7.4a3 3 0 00-2.1 2.1A31 31 0 001 12a31 31 0 001.2 3.5 3 3 0 002.1 2.1C6 18 12 18 12 18s6 0 7.7-.4a3 3 0 002.1-2.1A31 31 0 0023 12a31 31 0 00-1.2-3.5zM10 15V9l6 3-6 3z" />
              </svg>
            </a>
          </div>
        </div>
      ...
      <div className="border-t border-border/60 bg-black/95 py-4 text-center text-xs text-white">
        © {new Date().getFullYear()} Monastery360 • Inspired by NTB design •
        All rights reserved
      </div>
    </footer>
  );
